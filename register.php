...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error_message)) {
        ...
        $query = $conn->prepare("INSERT INTO users (first_name, middle_name, last_name, email, role, username, birthdate, gender, password, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())");
        $query->bind_param('sssssssss', $first_name, $middle_name, $last_name, $email, $role, $username, $birthdate, $gender, $password);
